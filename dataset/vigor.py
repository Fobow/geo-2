...
class VigorDatasetTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for yaw in [225, 315, 45, 135]:
            grd_view = equirectangular_to_perspective(query_img, fov=90, theta=yaw, phi=0, out_size=(512, 512), vertical_fov=180)
...
class VigorDatasetEval(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.img_type == "reference":
            ...
            ground_views = []
            for yaw in [225, 315, 45, 135]:
                grd_view = equirectangular_to_perspective(img, fov=90, theta=yaw, phi=0, out_size=(512, 512), vertical_fov=180)
                ground_views.append(grd_view)
