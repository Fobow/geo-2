...
df_train = pd.read_csv('/opt/tiger/dataset/cvusa/splits/train-19zl.csv', header=None)
...
df_gps = pd.read_csv('/opt/tiger/dataset/cvusa/split_locations/all.csv', header=None)
...
print("Saving...") 
with open("/opt/tiger/dino/GeoDiffuse/dataset/gps_dict/cvusa_gps_dict.pkl", "wb") as f:
