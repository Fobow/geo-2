...
from dataset.cvact import CVACTDatasetTrain
...
dataset = CVACTDatasetTrain(data_folder = "/opt/tiger/dataset/cvact")

anuData = sio.loadmat('/opt/tiger/dino/GeoDiffuse/dataset/ACT_data.mat')
...
print("Saving...") 
with open("/opt/tiger/dino/GeoDiffuse/dataset/gps_dict/cvact_gps_dict.pkl", "wb") as f:
