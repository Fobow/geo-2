...
import pickle
from dataset.vigor import VigorDatasetTrain
...
dataset = VigorDatasetTrain(data_folder="/opt/tiger/dataset/vigor",
                            same_area=SAME_AREA)
...
print("Saving...")  
with open("/opt/tiger/dino/GeoDiffuse/dataset/gps_dict/vigor_same_gps_dict.pkl", "wb") as f:
...
print("Saving...")  
with open("/opt/tiger/dino/GeoDiffuse/dataset/gps_dict/vigor_cross_gps_dict.pkl", "wb") as f:
    pickle.dump(near_neighbors, f)   